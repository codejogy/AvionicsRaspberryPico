...
_control_mode = 0b0001 # Single measurement mode
_control_bit = 0b1

_magn_control_1_byte[0] = _control_bit << 4 | _control_mode
i2c.writeto_mem(ADDRESS,_magn_control_1_address,_magn_control_1_byte)
...
i2c.writeto_mem(ADDRESS, _magn_control_2_address, _magn_control_2_byte)

# MEASUREMENT DATA
_meas_magn_register = 0x03
_meas_magn_bytes = bytearray(6)

i2c.readfrom_mem_into(ADDRESS,_meas_magn_register,_meas_magn_bytes)
...
print(accel_xout,accel_yout,accel_zout,temperature,gyro_xout,gyro_yout,gyro_zout) 
print("Aceleración en Z",accel_zout/2048*9.8)
